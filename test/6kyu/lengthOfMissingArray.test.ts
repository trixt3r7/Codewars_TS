...
describe("Length of missing array", function(){
  it("Basic Tests", function(){
    ...
    assert.strictEqual(getLengthOfMissingArray([ [], [ 0, 0, 0 ], [ 4, 0, 3, 4 ], [ 2, 1 ] ]), 1);
    assert.strictEqual(getLengthOfMissingArray([ [1, 2], [1], [], [3, 3, 1, 0, 3, 2, 4], [4, 1, 2, 2, 1, 4, 2, 4, 4], [2, 2, 1], [1, 2, 3, 4], [2, 1, 1, 4, 4, 0], [0, 0, 1, 1, 1, 0, 3, 2] ]), 5);
  });
});